...
func TestAccessor(t *testing.T) {
    ...
    resultAccessorIdIllegal := gokits.UnJson(
        ...
        new(types.AccessorManage)).(*types.AccessorManage)
    ...
    signatureQuery, _ := SHA1WithRSA.SignBase64ByKeyString(
        "nonsense=query", dummy.TestPrivateKeyString)
    ...
    a.Equal(dummy.TestPublicKeyString, resultQuery.AccessorPubKey)
    ...
    signatureUpdate, _ := SHA1WithRSA.SignBase64ByKeyString(
        "accessorName=test&nonsense=update", dummy.TestPrivateKeyString)
    ...
    signatureReset, _ := SHA1WithRSA.SignBase64ByKeyString(
        "nonsense=reset", dummy.TestPrivateKeyString)
