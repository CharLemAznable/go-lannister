...
func init() {
    common.RegisterMerchantManageSql("mysql", &MerchantManageSql{})
    common.RegisterMerchantVerifySql("mysql", &MerchantVerifySql{})

    base.RegisterMerchantManageDao("mysql", common.NewMerchantManageDao)
    base.RegisterMerchantVerifyDao("mysql", common.NewMerchantVerifyDao)
}
